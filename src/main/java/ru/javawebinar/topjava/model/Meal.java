...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.ALL_BETWEEN, query = "SELECT m FROM Meal m LEFT JOIN FETCH m.user " +
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String ALL_BETWEEN = "Meal.getAllSortedBetweenHalfOpen";
