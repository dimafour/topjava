...
<div class="jumbotron pt-4">
    <div class="container">
                ...
                <form id="filter">
                    <div class="row">
                        <div class="col-2">
                            ...
                            <input type="date" name="startDate" id="startDate" value="${param.startDate}"></div>
                        <div class="col-2">
                            <label for="endDate"> <spring:message code="meal.endDate"/>: </label>
                            <input type="date" name="endDate" id="endDate" value="${param.endDate}"></div>
        ...
        <br>
        <button type="button" class="btn btn-dark" onclick="add()"><spring:message code="meal.add"/></button>
        <br>
        <table class="table table-striped" id="datatable">
            ...
            <c:forEach items="${requestScope.meals}" var="meal">
                ...
                <tr id="${meal.id}" data-meal-excess="${meal.excess}">
                    <td>${fn:formatDateTimeISO(meal.dateTime)}</td>
